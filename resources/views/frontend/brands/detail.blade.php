...
@section('content')
    ...
    <div class="container mb-30">
        <div class="archive-header-2 text-center pt-80 pb-50">
            <h1 class="display-2 mb-50">{{$brand->name}}</h1>
            <div class="row">
            ...
            <div class="col-lg-4-5">
                <div class="shop-product-fillter">
                    <div class="totall-product">
                        <p>We found <strong class="text-brand">{{!empty($products) ? count($products) : 0}}</strong>
                            items for you!</p>
                    </div>
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href="{{route('products.detail',['name'=>$product->slug])}}">
                                            <img class="default-img" src="{{asset('/storage/'. $product->avatar)}}"
                                                 alt=""/>
            ...
            <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
                <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                    ...
                    <div class="vendor-info">
                        <h4 class="mb-5"><a href="{{route('brands.detail',['slug' => $brand->slug])}}"
                                            class="text-heading">{{$brand->name}}</a></h4>
                        ...
                        <div class="vendor-des mb-30">
                            <p class="font-sm text-heading">{{$brand->description}}</p>
                        </div>
