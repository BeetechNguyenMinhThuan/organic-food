                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="detail-info pr-30 pl-30">
                            ...
                            <h3 class="title-detail"><a href="{{route('products.detail',$item->slug)}}" class="text-heading">{{$item->name}}</a></h3>
                            ...
                            <div class="clearfix product-price-cover">
                                <div class="product-price primary-color float-left">
                                    ...
                                    <span>
                                            ...
                                            <span class="old-price font-md ml-15">{!! $item->getPrice() !!}</span>
                                        </span>
                                </div>
                            </div>
                            ...
                            <div class="font-xs">
                                <ul>
                                    <li class="mb-5">Brand: <span class="text-brand">{{optional($item->brand)->name}}</span></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Detail Info -->
