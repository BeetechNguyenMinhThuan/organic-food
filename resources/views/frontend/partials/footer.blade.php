                ...
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        <div class="newsletter-content">
                            <h2 class="mb-20">
                                {!! trans('messages.auth.stay_home') !!}
                            </h2>
                            <p class="mb-45"> {!! trans('messages.auth.daily_shopping') !!}</span>
                            </p>
                            <form class="form-subcriber d-flex">
                                <input type="email" placeholder="{!! trans('messages.auth.your_email') !!}"/>
                                <button class="btn" type="submit">{!! trans('messages.auth.subscribe') !!}</button>
                            </form>
                        </div>
                        <img src="{{asset('frontend/assets/imgs/banner/newsletter-image.png')}}" alt="newsletter"/>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp"
                        ...
                        <ul class="contact-infor">
                            ...
                            <li><img src="{{asset('frontend/assets/imgs/theme/icons/icon-clock.svg')}}" alt=""/><strong>Hours:</strong><span>10:00 - 18:00, Mon - Sat</span>
                            </li>
                        </ul>
                    </div>
                </div>
